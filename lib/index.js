...
var IntersectionList = function (_React$Component) {
    ...
    function IntersectionList(props) {
        ...
        _this.observer = new _intersectionObserverPolyfill2.default(_this.handleIntersectionObserve, {
            threshold: 0.01
        });
    ...
    _createClass(IntersectionList, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            var maxRenderCount = nextProps.maxRenderCount;
        ...
        value: function handleIntersectionObserve(entries, observer) {
            ...
            var overRender = this.props.overRender;
            var observedUntil = this.state.observedUntil;
        ...
        value: function render() {
            ...
            var renderChildren = children.slice(0, observedUntil + overRender).slice(0, maxRenderCount);

            /* create filler rows */
            var FillTag = fillerTagName;
            var fillChildren = [].concat(_toConsumableArray(Array(Math.max(0, maxRenderCount - observedUntil - overRender)))).map(function (val, index) {
...
IntersectionList.propTypes = {
    ...
    overRender: _propTypes2.default.number,
